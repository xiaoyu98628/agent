...
def create_provider(config: ModelConfig) -> OpenAIClient:
    return OpenAIClient.from_provider_setup(
...
class OpenAIClient:
    ...
    @classmethod
    def from_provider_setup(cls, provider_setup: ConfiguredProvider, default_temperature: float | int | None = None) -> OpenAIClient:
